	...
	function showEvents(){
		...
		var user_input = document.getElementById('input_search').value
		console.log(user_input)
		var url = "https://app.ticketmaster.com/discovery/v2/events.json?apikey=lgBmSsjcDDRRhKuGWt00Bwkwi9DGx1pg&countryCode=US&marketId=35"+"&keyword="+user_input
